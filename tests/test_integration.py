...
from compact_frame_format.cff import Cff, PREAMBLE, ParseResultEnum
...
class TestEndToEndWorkflow:
    ...
    def test_systematic_byte_corruption_error_recovery(self, stream_data: bytes, expected_payloads: List[bytes], frame_handler: Cff):
        """Test systematic byte corruption - corrupting any single byte should result in exactly one frame being lost."""
